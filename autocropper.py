...
def main():
    ...
    video_id='6Nc2rg-Tqn0'
    url = 'https://www.youtube.com/watch?v='+video_id  # Replace with your video's URL
    filename = fr'C:\Users\Beffa\Documents\Python\AI-Shorts-Creator-main\input\{video_id}_input_video.mp4'
    download_video(url,filename)
    transcript = get_transcript(video_id)
    print(transcript)

    try:
        interesting_segment = { "content": [ { "start_time": 556.399, "end_time": 581.88, "description": "Davi não sabe o nome da sogra, gerando risadas e descontração na conversa." }, { "start_time": 759.04, "end_time": 784.6, "description": "Poli demonstra desconforto ao falar sobre seu casamento, revelando detalhes engraçados e constrangedores." }, { "start_time": 946.12, "end_time": 973.4, "description": "Discussão sobre o cardápio inusitado do casamento de Poli, com destaque para o bolo de chocolate e estrogonofe na praia." } ] }
